...
export const SILO_BRIDGE: AddressMap = {
  ...
  [ChainId.MATIC]: '0x8518DE0b85230FE1a46831876c90cF4449680380',
};
...
export const SILO_CHAINLINK_ORACLE: AddressMap = {
  [ChainId.KOVAN]: '0x4C6A44ba783ED9A179d26C789F0AA3175C34Befc',
  [ChainId.MATIC]: '0x4C6A44ba783ED9A179d26C789F0AA3175C34Befc',
};

export const SILO_CHAINLINK_ORACLE_USD: AddressMap = {
  [ChainId.KOVAN]: '0xd55aFE85CeAcBC728B64e151A49001CC516A3300',
  [ChainId.MATIC]: '0xd55aFE85CeAcBC728B64e151A49001CC516A3300',
};

export const SILO_ROUTER: AddressMap = {
  [ChainId.KOVAN]: '0x9C3C740b92698b36193C5CC831effa3421f47269',
  [ChainId.MATIC]: '0x9AD0A2be3B87062DD6Ca0D4B0C58FD6E6DA15fBe',
};

export const UNISWAP_V3_ORACLE: AddressMap = {
  [ChainId.KOVAN]: '0x009f432bD2fFfebe383361482803B51a951e4976',
  [ChainId.MATIC]: '0xa6A9DB36065a06c3637BbFD6B4C7057a5ef3FF20',
};
