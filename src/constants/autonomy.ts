...
export const STOP_LIMIT_ORDER_WRAPPER_ADDRESSES: AddressMap = {
  ...
  [ChainId.AVALANCHE]: '0x0000000000000000000000000000000000000000', // not deployed yet
}

export const CHAINLINK_ORACLE_ADDRESS: AddressMap = {
  [ChainId.BSC]: '0x00632CFe43d8F9f8E6cD0d39Ffa3D4fa7ec73CFB',
  [ChainId.MATIC]: '0x18d087F8D22D409D3CD366AF00BD7AeF0BF11111', // not confirmed yet
  [ChainId.AVALANCHE]: '0x8f2CC3376078568a04eBC600ae5F0a036DBfd812', // not confirmed yet
}
