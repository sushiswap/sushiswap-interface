...
function Positions({ pairs }: any): JSX.Element | null {
  return (
    <div>
      <div className="grid gap-4 grid-cols-4 md:grid-cols-5 pb-4 px-4 text-sm font-semibold text-gray-500">
          ...
          return (
            <div key={pair.address}>
              <Link to={'/bento/kashi/pair/' + pair.address + '/lend'} className="block text-high-emphesis">
                <div className="grid gap-4 grid-cols-4 md:grid-cols-5 py-4 px-4 items-center align-center text-sm font-semibold rounded bg-dark-800 hover:bg-dark-blue">
