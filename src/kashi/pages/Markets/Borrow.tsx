...
export default function BorrowMarkets(): JSX.Element {
    ...
    const pairs = useSearchAndSort(fullPairs, { keys: ['search'], threshold: 0.1 }, { key: 'totalAssetAmount.usdValue', direction: 'descending' })
        ...
        >
            ...
            >
                    ...
                    <div className="pb-4">
                        <div>
                            <div className="grid gap-4 grid-cols-4 md:grid-cols-6 lg:grid-cols-7 pb-4 px-4 text-sm text-secondary">
                                <ListHeaderWithSort className="col-span-1 md:col-span-2 lg:col-span-3" sort={positions} sortKey='search'>
                                    <span className="hidden md:inline-block">Your</span> Positions
                                </ListHeaderWithSort>
                                <ListHeaderWithSort className="justify-end" sort={positions} sortKey='currentUserBorrowAmount.usdValue' direction='descending'>Borrowed</ListHeaderWithSort>
                                <ListHeaderWithSort className="hidden md:flex justify-end" sort={positions} sortKey='userCollateralAmount.usdValue' direction='descending'>Collateral</ListHeaderWithSort>
                                <ListHeaderWithSort className="hidden lg:flex justify-end" sort={positions} sortKey='health.value' direction='descending'>Limit <span className="hidden md:inline-block">Used</span></ListHeaderWithSort>
                                <ListHeaderWithSort className="justify-end" sort={positions} sortKey='interestPerYear.value' direction='descending'>APR</ListHeaderWithSort>
                            </div>
                                            ...
                                            <Link to={'/bento/kashi/borrow/' + pair.address} className="block text-high-emphesis">
                                                <div className="grid gap-4 grid-cols-4 md:grid-cols-6 lg:grid-cols-7 py-4 px-4 items-center align-center  text-sm  rounded bg-dark-800 hover:bg-dark-pink">
                                                    ...
                                                    <div className="text-right">
                                                        <div>{formattedNum(pair.currentUserBorrowAmount.string, false)} {pair.asset.symbol}</div>
                                                        <div className="text-secondary text-sm">
                                                            {formattedNum(pair.currentUserBorrowAmount.usd, true)}
                                                        </div>
                                                    </div>
                                                    <div className="hidden md:block text-right">
                                                        <div>{formattedNum(pair.userCollateralAmount.string, false)} {pair.collateral.symbol}</div>
                                                        <div className="text-secondary text-sm">
                ...
                <div className="grid gap-4 grid-flow-col grid-cols-4 md:grid-cols-6 lg:grid-cols-7 pb-4 px-4 text-sm  text-secondary">
                    <ListHeaderWithSort sort={pairs} sortKey='search'>Markets</ListHeaderWithSort>
                    <ListHeaderWithSort className="hidden md:flex" sort={pairs} sortKey='asset.symbol'>Borrow</ListHeaderWithSort>
                    <ListHeaderWithSort className="hidden md:flex" sort={pairs} sortKey='collateral.symbol'>Collateral</ListHeaderWithSort>
                    <ListHeaderWithSort className="hidden lg:flex" sort={pairs} sortKey='oracle.name'>Oracle</ListHeaderWithSort>
                    <ListHeaderWithSort className="justify-end" sort={pairs} sortKey='currentBorrowAmount.usdValue' direction='descending'>Borrowed</ListHeaderWithSort>
                    <ListHeaderWithSort className="justify-end" sort={pairs} sortKey='totalAssetAmount.usdValue' direction='descending'>Available</ListHeaderWithSort>
                    <ListHeaderWithSort className="justify-end" sort={pairs} sortKey='currentInterestPerYear.value' direction='descending'>APR</ListHeaderWithSort>
                </div>
                <div className="flex-col space-y-2">
                    {pairs.items &&
