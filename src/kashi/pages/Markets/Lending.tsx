...
export default function LendingMarkets(): JSX.Element | null {
    ...
    const pairs = useSearchAndSort(fullPairs, { keys: ['search'], threshold: 0.1 }, { key: 'currentSupplyAPR.value', direction: 'descending'})
            ...
            <Card className="bg-dark-900" header={<MarketHeader type="Lending" lists={[pairs, positions]} />}>
                    ...
                    <div className="pb-4">
                        <div>
                            <div className="grid gap-4 grid-flow-col grid-cols-4 md:grid-cols-6 lg:grid-cols-7 pb-4 px-4 text-sm text-secondary">
                                <ListHeaderWithSort sort={positions} sortKey='search'><span className="hidden md:inline-block">Your</span> Positions</ListHeaderWithSort>
                                <ListHeaderWithSort className="hidden md:flex" sort={positions} sortKey='asset.symbol'>Lending</ListHeaderWithSort>
                                <ListHeaderWithSort className="hidden md:flex" sort={positions} sortKey='collateral.symbol'>Collateral</ListHeaderWithSort>
                                <ListHeaderWithSort className="hidden lg:flex" sort={positions} sortKey='oracle.name'>Oracle</ListHeaderWithSort>
                                <ListHeaderWithSort className="justify-end" sort={positions} sortKey='currentUserAssetAmount.usdValue' direction='descending'>Lent</ListHeaderWithSort>
                                <ListHeaderWithSort className="justify-end" sort={positions} sortKey='currentUserLentAmount.usdValue' direction='descending'>Borrowed</ListHeaderWithSort>
                                <ListHeaderWithSort className="justify-end" sort={positions} sortKey='supplyAPR.value' direction='descending'>APR</ListHeaderWithSort>
                            </div>
                ...
                <div>
                    <div className="grid gap-4 grid-flow-col grid-cols-3 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-7 pb-4 px-4 text-sm text-secondary">
                        ...
                        <ListHeaderWithSort className="hidden md:flex" sort={pairs} sortKey='asset.symbol'>Lending</ListHeaderWithSort>
                        ...
                        <ListHeaderWithSort className="justify-end" sort={pairs} sortKey='currentSupplyAPR.value' direction='descending'>APR</ListHeaderWithSort>
                        <ListHeaderWithSort className="hidden sm:flex justify-end" sort={pairs} sortKey='utilization.value' direction='descending'>Borrowed</ListHeaderWithSort>
                        <ListHeaderWithSort className="justify-end" sort={pairs} sortKey='currentAllAssets.usdValue' direction='descending'>Total</ListHeaderWithSort>
                    </div>
                    <div className="flex-col space-y-2">
                        {pairs.items &&
