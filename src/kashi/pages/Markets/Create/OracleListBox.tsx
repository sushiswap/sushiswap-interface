...
const ORACLE_IMAGE: { [key: number]: string } = {
    1: `${process.env.PUBLIC_URL}/images/oracles/chainlink.jpg`,
    2: `${process.env.PUBLIC_URL}/images/oracles/sushiswap.jpg`
}

function OracleListBox({ oracles, selectedOracle, setSelectedOracle }: any): JSX.Element {
    return (
                                ...
                                <span className="inline-block w-full rounded-md shadow-sm">
                                    <Listbox.Button className="cursor-pointer relative w-full rounded-md border bg-input border-none p-3 text-left focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition ease-in-out duration-150 sm:text-sm sm:leading-5">
                                        <span className="truncate flex items-center">
                                            <AsyncIcon
                                                src={ORACLE_IMAGE[selectedOracle?.id]}
