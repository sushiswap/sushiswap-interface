...
const ALCHEMY_MAINNET_KEY = process.env.NEXT_PUBLIC_ALCHEMY_MAINNET_KEY;
const ALCHEMY_RINKEBY_KEY = process.env.NEXT_PUBLIC_ALCHEMY_RINKEBY_KEY;

const RPC = {
  [ChainId.MAINNET]: `https://eth-mainnet.alchemyapi.io/v2/${ALCHEMY_MAINNET_KEY}`,
  [ChainId.ROPSTEN]: 'https://eth-ropsten.alchemyapi.io/v2/addkey',
  [ChainId.RINKEBY]: `https://eth-rinkeby.alchemyapi.io/v2/${ALCHEMY_MAINNET_KEY}`,
  [ChainId.GÖRLI]: 'https://eth-goerli.alchemyapi.io/v2/addkey',
