...
const DoubleGlowShadow: FC<{ className?: string }> = ({ children, className }) => {
  ...
  return (
    <div className={classNames(className, 'relative w-full max-w-2xl')}>
      <div className="absolute top-1/4 -left-10 bg-deblock-darkblue bottom-4 w-3/5 rounded-full z-0 filter blur-[150px]" />
      <div className="absolute bottom-1/4 -right-10 bg-deblock-lightblue top-4 w-3/5 rounded-full z-0  filter blur-[150px]" />
