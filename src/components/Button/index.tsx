...
const FILLED = {
    ...
    green: 'bg-green bg-opacity-80 w-full rounded text-base text-high-emphesis hover:bg-opacity-100',
...
const OUTLINED = {
    ...
    green: 'bg-green bg-opacity-20 outline-green rounded text-xs text-green hover:bg-opacity-40',
...
export type ButtonColor = 'blue' | 'pink' | 'gradient' | 'gray' | 'default' | 'green' | 'red'

export type ButtonSize = 'tiny' | 'small' | 'large' | 'default'
