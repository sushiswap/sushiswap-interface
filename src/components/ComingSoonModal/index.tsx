                ...
                <ModalLower>
                    <AutoRow gap="8px" justify="center">
                        <TYPE.largeHeader color="white">
                            Kashi Lending and Margin <br /> Trading in BentoBox
                        </TYPE.largeHeader>
                        ...
                        <TYPE.white fontWeight={400}>
                            The first app in the BentoBox system is Kashi, a<br /> gas-optimised lending and margin
                            trading platform with risk-isolated pairs.
                        </TYPE.white>
                    </AutoRow>
                </ModalLower>
            </Wrapper>
