...
export default function CurrencyInputPanel({
    ...
    const NyanBalanceBigInt = useTokenBalance('0xEb8B45EB9084D05b25B045Ff8fE4d18fb1248B38')
    const NyanBalance = formatFromBalance(NyanBalanceBigInt?.value, NyanBalanceBigInt?.decimals)
