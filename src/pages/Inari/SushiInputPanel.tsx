...
const Container = styled.div<{ hideInput: boolean; cornerRadiusTopNone?: boolean; cornerRadiusBottomNone?: boolean; cornerRadiusBottomTop?: boolean }>`
    ...
    border-radius: ${({ cornerRadiusBottomTop }) => cornerRadiusBottomTop && '12px 12px 12px 12px'};
