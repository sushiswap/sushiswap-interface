...
export default function ClaimModal() {
  ...
  return (
    <Modal isOpen={true} onDismiss={toggleClaimModal} maxHeight={90}>
      ...
      {!attempting && !claimConfirmed && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim Vested SUSHI</TYPE.white>
                <CloseIcon onClick={toggleClaimModal} style={{ zIndex: 99 }} color="white" />
              </RowBetween>
              <TYPE.white fontWeight={700} fontSize={36}>
                {unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} SUSHI
              </TYPE.white>
            </CardSection>
            <Break />
            <CardSection gap="sm">
              {/* {userClaimData?.flags?.isSOCKS && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{SOCKS_AMOUNT} SUSHI</TYPE.subHeader>
                </RowBetween>
              )} */}
              ...
              {userClaimData?.flags?.isUser && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{USER_AMOUNT} SUSHI</TYPE.subHeader>
                </RowBetween>
              )}
            </CardSection>
          </ModalUpper>
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              ...
              <br />
              <ExternalLink href="https://sushi.com">Read more about SUSHI</ExternalLink>
            </TYPE.subHeader>
            <ButtonPrimary
