...
export default function Pair() {
  ...
  return (
            ...
            <div className="flex justify-between">
              ...
              <div className="flex items-center">
                <div className="text-lg text-high-emphesis">
                  {formatNumber(pair.totalAssetAmount.string)}{" "}
                  {pair.asset.symbol}
                </div>
              </div>
            </div>
                      ...
                      <div className="text-lg text-high-emphesis">
                        {formatNumber(
                          liquidityPair?.reserve1
                            ...
                            .add(
                              liquidityPair?.reserve1.multiply(
                                collateralPrice?.raw
                              )
                            )
                            .toSignificant(4),
    ...
    >
      <Head>
        <title>
          {i18n._(t`Borrow ${pair?.asset?.symbol}-${pair?.collateral?.symbol}`)}{" "}
          | Sushi
        </title>
        <meta
          name="description"
        ...
        <div className="flex justify-between mb-8">
          <div>
            ...
            <div className="text-2xl text-blue">
              {formatNumber(pair.userCollateralAmount.string)}{" "}
              {pair.collateral.symbol}
            </div>
            <div className="text-lg text-high-emphesis">
          ...
          <div>
            ...
            <div className="text-2xl text-pink">
              {formatNumber(pair.currentUserBorrowAmount.string)}{" "}
              {pair.asset.symbol}
            </div>
