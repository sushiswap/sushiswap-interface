  ...
  return (
    <>
      <Head>
        ...
        />
        <meta key="url" name="twitter:url" content="https://app.sushi.com/stake" />
        <meta key="title" name="twitter:title" content="STAKE SUSHI" />
        <meta
          key="description"
          name="twitter:description"
          content="Stake SUSHI in return for xSUSHI, an interest bearing and fungible ERC20 token designed to share revenue generated by all SUSHI products."
        />
        <meta key="image" name="twitter:image" content="https://app.sushi.com/xsushi-sign.png" />

        <meta key="title" property="og:title" content="STAKE SUSHI" />
        <meta key="url" property="og:url" content="https://sushi.com/stake" />
        <meta key="image" property="og:image" content="https://app.sushi.com/xsushi-sign.png" />
        <meta
          key="description"
