...
export default function Pair() {
  ...
  if (!pair)
    return info && info.blockTimeStamp.isZero() ? null : router.push("/lend");
  ...
  return (
        ...
        <Card className="h-full bg-dark-900">
          <div className="flex-col space-y-2">
            <div className="flex justify-between">
              <div className="text-xl text-high-emphesis">
                {i18n._(t`Market Info`)}
              </div>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              ...
              <div className="flex items-center">
                <div className="text-lg text-high-emphesis">
                  {formatNumber(pair.totalCollateralAmount.string)}{" "}
            ...
            <div className="flex justify-between">
              <div className="text-lg text-secondary">
                {i18n._(t`${pair.asset.symbol} Strategy`)}
              </div>
              <div className="text-lg text-high-emphesis">
                {i18n._(t`None`)}
                <QuestionHelper
    ...
    >
      <Head>
        ...
        <meta
          name="description"
          content={`Lend ${pair.asset.symbol} on Kashi`}
        />
      </Head>
      <Card
        className="h-full bg-dark-900"
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-3xl text-high-emphesis">
                    Lend {pair && pair.asset.symbol}
                  </div>
                  <div className="flex items-center">
                    <div className="mr-1 text-sm text-secondary">
                      Collateral:
                    </div>
        ...
        <div className="flex justify-between mb-8">
          <div>
            ...
            <div className="text-2xl text-blue">
              {formatNumber(pair.currentUserAssetAmount.string)}{" "}
              {pair.asset.symbol}
            </div>
            <div className="text-lg text-high-emphesis">
          ...
          <div>
            ...
            <div className="text-2xl text-high-emphesis">
              {formatPercent(pair.utilization.string)}
            </div>
          </div>
