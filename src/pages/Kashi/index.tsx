            ...
            <AutoColumn gap="md">
              ...
              <RowBetween>
                <TYPE.white fontSize={14} color={theme.text2}>
                  {`BentoBox is a revolutionary new way from SUSHI to interact with dapps on L1 in a highly gas efficient manner. In order to use any one of the decentralized BentoApps below you'll need to first approve BentoBox and deposit any erc20 asset to your Bentobox balance.`}
                </TYPE.white>
              </RowBetween>
            </AutoColumn>
          </CardSection>
