...
export default function OnsenJumbotron({ onsenView }: any) {
    ...
    return (
        <div>
            <div className="flex flex-row justify-between">
                <div className="py-6">
                    {onsenView === ONSEN_VIEWS.ALL_POOLS && (
                        <>
                            <div className="font-bold text-h1 text-high-emphesis mb-4">
                                Yield Farming with ONSEN
                            </div>
                    ...
                    {onsenView === ONSEN_VIEWS.USER_POOLS && (
                        <>
                            <div className="font-bold text-h3 text-high-emphesis">
                                My Positions
                            </div>
                            <div className="pt-6">
                                <div>
                                    <div className="inline text-body">You have </div>
                                    <div className="inline text-h4 text-cyan-blue font-bold">{formattedNum(userTotalAssets, true)} </div>
                                    <div className="inline text-body">total assets in the ONSEN:</div>
                                </div>
                                <div>
                                    <div className="inline text-h4 text-blue font-bold">{formattedNum(userTotalStaked, true)} </div>
                                    <div className="inline text-body">assets staked and </div>
                                    <div className="inline text-h4 text-pink font-bold">{formattedNum(userTotalRewards, true)} </div>
            ...
            <div className="text-h5 text-high-emphesis py-4">
                Explore {farmsCount} Farms (and counting).
            </div>
        </div>
    )
}