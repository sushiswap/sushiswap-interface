...
import { Search, Button, OnsenCategory, OnsenTable, OnsenJumbotron } from './components'
import { Helmet } from 'react-helmet'
import { Farm, ONSEN_CATEGORY, ONSEN_VIEWS } from './types'
                ...
                <div>
                    ...
                    <div className="flex flex-row flex-nowrap sm:space-x-5 pt-6 bp-4">
                        <Button
                            ...
                            onClick={() => { setOnsenView(ONSEN_VIEWS.ALL_POOLS) }}
                        >
                            Pool List
                        </Button>
                        <Button
                            ...
                            onClick={() => { setOnsenView(ONSEN_VIEWS.USER_POOLS) }}
                        >
                            My Positions
                        </Button>
