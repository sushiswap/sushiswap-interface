...
export const getTokenBalances = (chainId = ChainId.MAINNET, address) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/address/${address}/balances_v2/`)

export const getPortfolio = (chainId = ChainId.MAINNET, address) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/address/${address}/portfolio_v2/`)

export const getTransfers = (chainId = ChainId.MAINNET, address) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/address/${address}/transfers_v2/`)
...
export const getBlockHeights = (chainId = ChainId.MAINNET, startDate, endDate) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/block_v2/${startDate}/${endDate}`)
...
export const getNftMetadata = (chainId = ChainId.MAINNET, address, tokenId) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/tokens/${address}/nft_metadata/${tokenId}`)

export const getNftTokenIds = (chainId = ChainId.MAINNET, address) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/tokens/${address}/nft_token_ids/`)

export const getNftTransactions = (chainId = ChainId.MAINNET, address, tokenId) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/tokens/${address}/nft_transactions/${tokenId}`)

export const getHoldersChanges = (chainId = ChainId.MAINNET, address) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/tokens/${address}/token_holders_changes/`)

export const getTokenHolders = (chainId = ChainId.MAINNET, address) =>
    fetch(`https://api.covalenthq.com/v1/${chainId}/tokens/${address}/token_holders/`)
...
export const getChainStatus = () => fetch(`https://api.covalenthq.com/v1/chains/status`)
