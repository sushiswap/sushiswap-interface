      ...
      {!currencyList && (
        <div className="mt-0 mb-3 sm:mt-3 sm:mb-8">
          <input
            ...
            className="w-full bg-transparent border border-dark-700 focus:border-transparent focus:border-indigo-400 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5"
          />
        </div>
      )}
      {showCommonBases && (
