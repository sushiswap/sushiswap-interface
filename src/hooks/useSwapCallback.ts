...
import { getArcherRouterContract, getRouterAddress, getRouterContract } from '../functions/contract'
...
export function useSwapCallArguments(
    ...
    }, [account, allowedSlippage, chainId, deadline, library, recipient, trade, useArcher, archerETHTip, router])
}
