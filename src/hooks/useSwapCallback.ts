import { ChainId, Currency, CurrencyAmount, Percent, Router, TradeType, Trade as V2Trade } from '@sushiswap/core-sdk'
    ...
    return {
      ...
      callback: async function onSwap(): Promise<string> {
        ...
        if (!useArcher && !useOpenMev) {
          ...
          /**
           * postToOpenMevRelay
           * @const postToOpenMevRelay
           *
           * @async
           * @param {string} signedTx
           * @param {boolean} isMetamask
           * @returns {res.statusText}
           */
