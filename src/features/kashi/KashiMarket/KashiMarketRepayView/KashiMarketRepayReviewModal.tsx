...
export const KashiMarketRepayReviewModal: FC<KashiMarketRepayReviewModal> = ({
  ...
  const repayAmountCurrencyAmount = CurrencyAmount.fromRawAmount(market.asset.token, market.currentUserBorrowAmount)
  const removeAmountCurrencyAmount = CurrencyAmount.fromRawAmount(market.collateral.token, market.userCollateralAmount)
