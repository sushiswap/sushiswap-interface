...
export default function CurrencyInputPanel({
  ...
  const currencyUSDC = useUSDCPrice(currency && chainId in USDC ? currency : undefined)?.toFixed(18)
        ...
        <div id={id} className="rounded bg-dark-800">
                ...
                <>
                  <div className="flex flex-col">
                    ...
                    {chainId && chainId in USDC && (
                      <div className="text-xs font-medium text-low-emphesis">≈ {valueUSDC} USDC</div>
                    )}
                  </div>
                  ...
                  {helperText && (
                    <div className="flex flex-col">
                      <span className="text-xs font-bold text-high-emphesis text-right">{helperText}</span>
                    </div>
                  )}
                </>
              )}
          ...
          {customBalanceComponent ? (
            ...
            <div className="flex bg-dark-700 rounded-b px-5 py-1 justify-between">
              <div onClick={onMax} className="text-xs font-medium cursor-pointer">
            ...
            <>
              ...
              {account && (
                <div className="flex flex-col">
                  ...
                  {chainId && chainId in USDC && (
                    <div className="text-xs font-medium text-right text-secondary">≈ {valueUSDC} USDC</div>
                  )}
                </div>
              )}
            </>
