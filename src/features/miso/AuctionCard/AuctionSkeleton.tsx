const AuctionSkeleton = () => {
  return (
    <div className="h-[580px] animate-pulse rounded bg-dark-900 border border-dark-800 pt-5 overflow-hidden transition-all shadow-md hover:translate-y-[-3px] hover:shadow-xl hover:shadow-pink/5">
      <div className="h-full flex flex-col gap-3.5">
        ...
        <div className="flex h-full items-center px-5">
          <div className="h-2 rounded bg-dark-700 w-full transform rotate-[25deg]" />
        </div>
