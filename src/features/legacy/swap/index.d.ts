export function fromWei(value: any, doTypeConversion: any, unit: any): string
export function toWei(value: any, unit: any): import('bn.js')
export function calculateFee(gas: any, gasPrice: any, unit: any): import('bn.js')
export function determineGasFees(tx: any): (gasPrice: any, cb: any) => void
...
export class Blockchain {
   ...
   */
  createVMAccount(newAccount: { privateKey: string; balance: string }): any
