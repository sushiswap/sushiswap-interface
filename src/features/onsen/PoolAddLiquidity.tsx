...
import { Currency, CurrencyAmount, currencyEquals, NATIVE, Percent, WNATIVE } from '@sushiswap/core-sdk'
...
import { calculateGasMargin, calculateSlippageAmount, maxAmountSpend } from 'app/functions'
