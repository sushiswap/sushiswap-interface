...
const getTokenLogoURL = (address: string, chainId: any) => {
    ...
    if (chainId === ChainId.MAINNET) {
        ...
        imageURL = `https://v1exchange.pancakeswap.finance/images/coins/${isAddress(
            address
        )}.png`
...
export default function TokenLogo({
    ...
    if (address === 'kashiLogo') {
        return (
            <Inline>
                <Image {...rest} alt={''} src={'/kashi-logo.png'} size={size} />
            </Inline>
        )
    }
    ...
    if (
        address?.toLowerCase() === '0x5e74c9036fb86bd7ecdcb084a0673efc32ea31cb'
    ) {
        address = '0x42456d7084eacf4083f1140d3229471bba2949a8'
    }
    if (
        address?.toLowerCase() === '0xc011a73ee8576fb46f5e1c5751ca3b9fe0af2a6f'
    ) {
