...
import settingsAnimationData from '../assets/animation/settings-slider.json'
import { t } from '@lingui/macro'
import { useLingui } from '@lingui/react'

export default function ExchangeHeader({ input = undefined, output = undefined }: any): JSX.Element {
        ...
        <div className="flex justify-between space-x-3 mb-4">
            <div className="grid grid-cols-2 rounded-md p-3px md:bg-dark-800">
                ...
                <NavLink
                    ...
                    href={`/add/${input && input.address ? input.address : 'ETH'}${
