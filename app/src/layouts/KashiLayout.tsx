                            ...
                            <Link href="/borrow">
                                <a className="flex justify-center xl:justify-start xl:mx-8">
                                    <Image
                                        ...
                                        alt="Kashi"
                                        layout="intrinsic"
                                        // className="h-16 w-1/2 md:w-1/3 xl:w-full"
                                        height={64}
                                        width="auto"
                                    />
                                </a>
                            ...
                            <nav className="flex justify-between items-center w-full">
                                <div className="flex">
                                    <NavLink href="/lend">
                                        <a
                                            className={
                                                'border-transparent pl-4 pr-2 sm:pl-8 sm:pr-4 border-b-2 flex items-center font-medium ' +
                                    ...
                                    <NavLink href="/borrow">
                                        <a
                                            className={
                                                'border-transparent px-2 sm:px-4 border-b-2 flex items-center font-medium ' +
