describe('Remove Liquidity', () => {
    it('redirects', () => {
        cy.visit('/remove/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85-0xc778417E063141139Fce010982780140Aa0cD5Ab')
        cy.url().should(
            'contain',
            '/remove/0xF9bA5210F91D0474bd1e1DcDAeC4C58E359AaD85/0xc778417E063141139Fce010982780140Aa0cD5Ab'
        )
    })
    ...
    it('token not in storage is loaded', () => {
        ...
        cy.get('#remove-liquidity-tokena').should('contain.text', 'SKL')
        cy.get('#remove-liquidity-tokenb').should('contain.text', 'MKR')
    })
})
