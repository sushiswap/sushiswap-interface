...
describe('utils', () => {
    describe('#getExplorerLink', () => {
        it('correct for tx', () => {
            expect(getExplorerLink(1, 'abc', 'transaction')).toEqual(
                'https://etherscan.io/tx/abc'
            )
        })
        it('correct for token', () => {
            expect(getExplorerLink(1, 'abc', 'token')).toEqual(
                'https://etherscan.io/token/abc'
            )
        })
        it('correct for address', () => {
            expect(getExplorerLink(1, 'abc', 'address')).toEqual(
      ...
      expect(getExplorerLink(2, 'abc', 'address')).toEqual('https://etherscan.io/address/abc')
        ...
        it('ropsten', () => {
            expect(getExplorerLink(3, 'abc', 'address')).toEqual(
