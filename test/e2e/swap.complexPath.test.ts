...
const cases = [
  ['ETH', FUNDING_SOURCE.WALLET, 'USDT', FUNDING_SOURCE.WALLET],
  ['ETH', FUNDING_SOURCE.WALLET, 'BAT', FUNDING_SOURCE.WALLET],
]
...
describe('Trident Swap:', () => {
  ...
  test.only.each([['ETH', FUNDING_SOURCE.WALLET, 'BAT', FUNDING_SOURCE.WALLET]])(
